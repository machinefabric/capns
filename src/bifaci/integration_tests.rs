...
mod tests {
    ...
    async fn test1122_full_path_engine_req_to_cartridge_response() {
        ...
        let manifest = r#"{"name":"EchoCartridge","version":"1.0","channel":"release","registry_url":null,"description":"Echo test cartridge","cap_groups":[{"name":"default","caps":[{"urn":"cap:in=media:;out=media:","title":"Test","command":"test","args":[]}]}]}"#;
