...
2. **Resolve cap URNs**: For each edge, look up the cap URN in the `FabricRegistry` to get the full `Cap` definition with arguments, metadata, and validated URN structure.
